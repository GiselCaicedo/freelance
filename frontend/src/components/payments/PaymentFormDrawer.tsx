      ...
      <div className="space-y-5 px-5 py-5">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
          <input
            ...
            onChange={(event) => setConfirmed(event.target.checked ? true : false)}
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Registra enlaces adicionales que respalden el pago, como soportes o facturas asociadas.
          </p>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="https://..."
                        className="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-xs text-gray-900 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200"
                      />
                    </div>
                    <div>

                              ...
                              <form onSubmit={handleSendEmail} className="space-y-3">
                                <div>
                                  ...
                                  <textarea
                                    ...
                                    rows={2}
                                    className="w-full rounded-2xl border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none"
                                  />
                                </div>
                                <div>

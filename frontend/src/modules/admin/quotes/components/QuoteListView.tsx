    ...
    () => [
      {
        ...
        cellRenderer: (params: ICellRendererParams<QuoteRow>) => (
          <Link
            ...
            className="inline-flex items-center gap-2 text-left text-sm font-semibold text-sky-700 hover:underline"
          >
          ...
          params.data.pdfUrl
            ? (
                <Link
                  ...
                  className="inline-flex items-center gap-1 rounded-full border border-gray-200 px-3 py-1 text-xs font-medium text-sky-700 hover:bg-sky-50"
                >

...
export default function ClientDetailView({ client, parameters, serviceCatalog, locale }: ClientDetailViewProps) {
  ...
  return (
    <div className="space-y-6" ref={containerRef}>
      ...
      <SidePanel open={servicePanel.open} title={servicePanel.mode === 'edit' ? 'Editar servicio asignado' : 'Asignar servicio'} onClose={() => setServicePanel(prev => ({ ...prev, open: false }))} reserveRef={containerRef}>
        <AssignServicePanel

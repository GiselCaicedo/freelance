...
const statusLabel: Record<ClientStatus, { label: string; tone: string }> = {
  active: { label: 'Activo', tone: 'bg-sky-100 text-sky-700' },
    ...
    const baseColumns: ColDef<ClientRow>[] = [
      {
        ...
        cellRenderer: (params: ICellRendererParams<ClientRow>) => (
          <button
            ...
            className="flex items-center gap-2 text-left text-sm font-semibold text-sky-600 hover:underline"
          >
        ...
        <div className="mb-3 flex items-center justify-between">
          <div className="relative w-full max-w-sm">
            ...
            <input
              ...
              className="w-full rounded-full border border-gray-200 bg-white py-2 pr-3 pl-9 text-sm text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none"
            />
          </div>
        </div>
        <AgTable<ClientRow>

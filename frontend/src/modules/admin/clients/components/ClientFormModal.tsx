            ...
            <div className="mt-4 space-y-4">
              {orderedParameters.map(parameter => (
                <div key={parameter.id} className="rounded-lg border border-gray-200 bg-white p-3">
                  <label className="text-xs font-medium tracking-wide text-gray-500 uppercase" htmlFor={`parameter-${parameter.id}`}>
                    {parameter.name}
                  </label>
                  <input
                    ...
                    className="mt-2 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none"
                  />
                </div>
              ))}
            </div>

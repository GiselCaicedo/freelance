    ...
    <form onSubmit={handleSubmit} className="flex min-h-full flex-col">
        ...
        <div className="space-y-4 md:col-span-3">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none"
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 pl-10 text-sm text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none"
                  disabled={submitting}
                />
              </div>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none"
                disabled={submitting}
              />
            </div>
          </div>
      ...
      <div className="mt-auto flex justify-end gap-3 border-t border-gray-100 px-5 py-4">
        ...
        <button
          type="submit"
          disabled={!hasCatalog || submitting}
          className="rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500 disabled:cursor-not-allowed disabled:opacity-60"
        >

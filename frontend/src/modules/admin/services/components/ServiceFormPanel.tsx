    ...
    <form onSubmit={handleSubmit} className="space-y-5 p-5">
      <div>
        ...
        <input
          ...
          className="mt-1 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 focus:outline-none"
          required
        />
      </div>

    ...
    >
        ...
        {SETTINGS_NAV.map((group) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'flex items-center gap-2 whitespace-nowrap rounded-t-lg px-4 py-2.5 text-sm font-semibold transition-colors border-b-2',
      ...
      {SETTINGS_NAV.map((group) => {
        ...
        return (
          <div
            key={`${group.id}-items`}
            className="flex items-center gap-1 overflow-x-auto bg-slate-50 px-2 border-t border-slate-200"
          >
